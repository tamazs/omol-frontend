<template>
  <div class="about-content" @mousemove="handleMouseMove">
    ...
    <div class="text-container">
      <p>Compartir al momento, hablar con tu audiencia, contarles lo que haces casi en tiempo real es algo que está aquí.
      </p>
      <p>Por eso, nuestro servicio de grabación y edición con smartphones de última generación es rápido, entregado casi
        al instante!</p>
